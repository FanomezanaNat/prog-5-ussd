...
public class MenuService {
  ...
  private void initMenus() {
    ...
    menus.put("1-1", new Menu(
      ...
      public void handleInput(String input) {
        switch (input) {
          case "0": goBack(); break;
          case "1": handlePurchase(1000, "Crédit Standard 1000 Ar"); break;
          case "2": handlePurchase(2000, "Crédit Standard 2000 Ar"); break;
          case "3": handlePurchase(5000, "Crédit Standard 5000 Ar"); break;
          default: invalidInput();
        }
      }
    });

    menus.put("1-2", new Menu(
            "Crédit VIP:\n" +
                    "1. 10000 Ar\n" +
                    "2. 20000 Ar\n" +
                    "3. 50000 Ar\n" +
      ...
      public void handleInput(String input) {
        switch (input) {
          case "0": goBack(); break;
          case "1": handlePurchase(10000, "Crédit VIP 10000 Ar"); break;
          case "2": handlePurchase(20000, "Crédit VIP 20000 Ar"); break;
          case "3": handlePurchase(50000, "Crédit VIP 50000 Ar"); break;
          default: invalidInput();
        }
      }
    });

    menus.put("1-3", new Menu(
            """
                    Forfaits:
                    1. Internet - 1000 Ar
                    2. Appels - 1500 Ar
      ...
      public void handleInput(String input) {
        switch (input) {
          case "0": goBack(); break;
          case "1": handlePurchase(1000, "Forfait Internet"); break;
          case "2": handlePurchase(1500, "Forfait Appels"); break;
          case "3": handlePurchase(500, "Forfait SMS"); break;
          default: invalidInput();
        }
      }
    });
  ...
  private void confirmTransfer(String transferType) {
    ...
    System.out.println("Confirmer le transfert de " + amount + " Ar vers " + number + " via " + mapTransferType(transferType) + " ? (1=Oui, 0=Non)");
  ...
  private void askPassword(String transferType) {
    ...
    if (transactionService.verifyPassword(password)) {
      transactionService.processTransfer(state.getTempData().getNumber(), state.getTempData().getAmount(), mapTransferType(transferType));
